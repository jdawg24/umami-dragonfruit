    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &SugarchainGU::createWallet);
...
void SugarchainGUI::createActions()
{
    ...
    if(walletFrame)
    {
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &SugarchainGUI::createWallet);
        connect(m_close_all_wallets_action, &QAction::triggered, [this] {
            m_wallet_controller->closeAllWallets(this);
        });
        connect(m_migrate_wallet_action, &QAction::triggered, [this] {
            auto activity = new MigrateWalletActivity(m_wallet_controller, this);
            connect(activity, &MigrateWalletActivity::migrated, this, &SugarchainGUI::setCurrentWallet);
...
void SugarchainGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
...
void SugarchainGUI::createWallet()
{
#ifdef ENABLE_WALLET
#ifndef USE_SQLITE
